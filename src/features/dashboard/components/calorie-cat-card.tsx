...
const catOutline =
  "M52 70 L43 29 Q42 22 49 26 L83 50 C96 43 107 40 120 40 C133 40 144 43 157 50 L191 26 Q198 22 197 30 L188 70 C207 88 214 109 209 130 C201 166 166 181 120 181 C74 181 39 166 31 130 C26 109 33 88 52 70 Z";
  ...
  return (
    <Link href="/nutrition" className={styles.calorieCard}>
      <div className={styles.calorieCopy}>
        ...
        <h2>Calorías</h2>
        <p className={styles.calorieNumber}>
          {consumed.toLocaleString("es-GT")}
          <span> / {goal.toLocaleString("es-GT")} kcal</span>
        </p>
        <p className={styles.remainingCalories}>{remaining} kcal restantes</p>
      </div>
